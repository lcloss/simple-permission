...
@section('description', 'List of roles of the application')
@section('content')
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">{{ __('Roles') }}</h1>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-end mb-3">
                                @can('roles_create')
                                <a class="btn btn-outline-primary" href="{{ route('simple-permission.roles.create') }}">{{ __('New role') }}</a>
                                @endcan
                            </div>
                        </div>
                        <div class="card mb-3">
                            <div class="card-header">
                                <h3>{{ __('Roles') }}</h3>
                                <p class="mb-0">{{ __('List of roles') }}</p>
                            </div>
                            <div class="card-body">
                                @livewire('simple-permission::roles-list')
                            </div>
                        </div>
                    </div>
@endsection
