...
@section('description', 'List of permissions of the application')
@section('content')
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-end mb-3">
                                ...
                                <a class="btn btn-outline-primary" href="{{ route('simple-permission.permissions.create') }}">{{ __('New permission') }}</a>
                                @endcan
                            </div>
                        </div>
                        <div class="card mb-3">
                            <div class="card-header">
                                ...
                                <p class="mb-0">{{ __('List of permissions') }}</p>
                            </div>
                            <div class="card-body">
                                @livewire('simple-permission::permissions-list')
                            </div>
                        </div>
                    </div>
@endsection
